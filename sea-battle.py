...
print('инструкция:')
print('1. Корабли помечаются символом □, раненные символом - X, выстрелы мимо - Т')
...
print(
    '4. Чтобы поставить корабль нужно указать ряд и столбец его носа, затем направление (если вертикально, то нос смотрит вверх, если горизонтально, то нос смотрит вправо). Например: 1 1 вертикально')
print('5. Направление нужно указывать даже для однопалубного корабля')
print('6. В игре один корабль на 3 клетки, два корабля на 2 клетки и четыре корабля на 1 клетку')
print('7. Клетки вокруг убитого корабля автоматически помечаются символом Т, то есть мимо')
print('8. Приятной игры!')
while True:
